...
//
// bearbeitet von Caspar Armster
// Version 1.20

#define WEATHERPLUSESP8266VERSION "020"
...
void setup() {
  ...
  IPAddress _ip = IPAddress(10, 186, 8, 50);
  IPAddress _gw = IPAddress(10, 186, 8, 22);
  ...
  if (!wifiManager.autoConnect("Freifunk-Hennef")) {
